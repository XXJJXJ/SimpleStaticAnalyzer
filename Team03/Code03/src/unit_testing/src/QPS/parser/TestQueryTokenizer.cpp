...
TEST_CASE("QueryTokenizer::tokenize should remove trailing whitespaces") {
    ...
    std::vector<std::string> expectedResult3 =
        {"procedure", "p", ",", "p1", ";", "Select", "p", "such", "that", "Calls", "(", "p", ",", "p1", ")"};
...
TEST_CASE("QueryTokenizer::tokenize should correctly tokenize patterns") {
    ...
    std::vector<std::string>
        expectedResult1 = {"assign", "a", ";", "Select", "a", "pattern", "a", "(", "_", ",", "_", ")"};
    std::vector<std::string>
        expectedResult2 = {"assign", "a", ";", "Select", "a", "pattern", "a", "(", "_", ",", "_\"(a+b)\"_", ")"};
    std::vector<std::string>
        expectedResult3 = {"assign", "a", ";", "Select", "a", "pattern", "a", "(", "_", ",", "\"(a+b)\"", ")"};
    std::vector<std::string>
        expectedResult4 = {"assign", "a", ";", "Select", "a", "pattern", "a", "(", "_", ",", "\"(a+b)\"", ")"};
...
TEST_CASE("Testing tokenizing attrRefs") {
    ...
    std::vector<std::string> expectedResults1 =
        {"assign", "a", ";", "Select", "<", "a", ",", "a.procName", ",", "a.stmt#", ">", "with", "a.stmt#", "=", "8"};
