...
CallStatement::CallStatement(int statementNumber, shared_ptr<Procedure> procedure_, string procedureName) : procedure(
    std::move(procedure_)), Statement(statementNumber, EntityType::Call, procedureName) {}
