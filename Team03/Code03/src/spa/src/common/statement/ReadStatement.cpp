...
ReadStatement::ReadStatement(int statementNumber, shared_ptr<Variable> variable_, string procedureName)
    : variable(std::move(variable_)),
      Statement(std::move(statementNumber), EntityType::Read, std::move(procedureName)) {}
